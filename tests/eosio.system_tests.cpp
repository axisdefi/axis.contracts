...
BOOST_FIXTURE_TEST_CASE( buysell, eosio_system_tester ) try {
   ...
   {
      transfer( config::system_account_name, N(alice1111111), core_sym::from_string("1000.00000000"), config::system_account_name );
      ...
      const asset payment = core_sym::from_string("1000.00000000");
