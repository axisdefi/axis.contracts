...
//                         stake( "alice1111111", core_sym::from_string("-0.0001"), core_sym::from_string("0.00000000") )
//    );

//    BOOST_REQUIRE_EQUAL( wasm_assert_msg("must stake a positive amount"),
//                         stake( "alice1111111", core_sym::from_string("0.00000000"), core_sym::from_string("-0.0001") )
//    );
...
//                         unstake( "alice1111111", core_sym::from_string("200.0001"), core_sym::from_string("0.00000000") )
//    );

//    //trying to unstake more cpu bandwith than at stake
//    BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked cpu bandwidth"),
//                         unstake( "alice1111111", core_sym::from_string("0.00000000"), core_sym::from_string("100.0001") )
...
//    issue_and_transfer( N(alice1111111), core_sym::from_string("200000000.00000000"),  config::system_account_name );
...
//                         )
//    );
//    BOOST_REQUIRE_EQUAL( success(), stake( N(alice1111111), core_sym::from_string("100000000.00000000"), core_sym::from_string("100000000.00000000") ) );
...
//    BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("11.00000000"), core_sym::from_string("0.1111") ) );
...
//    BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", core_sym::from_string("22.00000000"), core_sym::from_string("0.2222") ) );
...
//    BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("33.00000000"), core_sym::from_string("0.3333") ) );
//    //alice1111111 stake with transfer to bob111111111
//    BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( N(alice1111111), N(bob111111111), core_sym::from_string("22.00000000"), core_sym::from_string("0.2222") ) );
...
//    BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", core_sym::from_string("2.00000000"), core_sym::from_string("0.0002")/*"2.00000000 EOS", "0.0002 EOS"*/ ) );
...
//    BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111", core_sym::from_string("20.00000000"), core_sym::from_string("0.2220") ) );
...
//    issue_and_transfer( "bob111111111", core_sym::from_string("2000.00000000"),  config::system_account_name );
//    BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111", core_sym::from_string("13.00000000"), core_sym::from_string("0.5791") ) );
...
//    issue_and_transfer( "carol1111111", core_sym::from_string("1000.00000000"),  config::system_account_name );
//    BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111", core_sym::from_string("15.0005"), core_sym::from_string("5.00000000") ) );
...
//    transfer( config::system_account_name, "producvotera", core_sym::from_string("400000000.00000000"), config::system_account_name);
//    BOOST_REQUIRE_EQUAL(success(), stake("producvotera", core_sym::from_string("100000000.00000000"), core_sym::from_string("100000000.00000000")));
...
//    t.transfer( config::system_account_name, "defproducera", core_sym::from_string("200000000.00000000"), config::system_account_name);
//    BOOST_REQUIRE_EQUAL(t.success(), t.stake("defproducera", core_sym::from_string("100000000.00000000"), core_sym::from_string("100000000.00000000")));
...
//       transfer( config::system_account_name, v, core_sym::from_string("100000000.00000000"), config::system_account_name );
//       BOOST_REQUIRE_EQUAL(success(), stake(v, core_sym::from_string("30000000.00000000"), core_sym::from_string("30000000.00000000")) );
//    }
...
//       t.transfer( config::system_account_name, v, old_core_from_string("100000000.00000000"), config::system_account_name );
//       BOOST_REQUIRE_EQUAL(t.success(), t.stake(v, old_core_from_string("30000000.00000000"), old_core_from_string("30000000.00000000")) );
//    }
...
//    transfer(config::system_account_name, "producvotera", core_sym::from_string("200000000.00000000"), config::system_account_name);
//    BOOST_REQUIRE_EQUAL(success(), stake("producvotera", core_sym::from_string("70000000.00000000"), core_sym::from_string("70000000.00000000") ));
//    BOOST_REQUIRE_EQUAL(success(), vote( N(producvotera), vector<account_name>(producer_names.begin(), producer_names.begin()+10)));
...
//    transfer(config::system_account_name, "producvoterb", core_sym::from_string("100000000.00000000"), config::system_account_name);
//    BOOST_REQUIRE_EQUAL(success(), stake("producvoterb", core_sym::from_string("4000000.00000000"), core_sym::from_string("4000000.00000000")));
//    transfer(config::system_account_name, "producvoterc", core_sym::from_string("100000000.00000000"), config::system_account_name);
//    BOOST_REQUIRE_EQUAL(success(), stake("producvoterc", core_sym::from_string("2000000.00000000"), core_sym::from_string("2000000.00000000")));
...
//    transfer( "eosio", "alice1111111", core_sym::from_string("600000000.00000000"), "eosio" );
//    BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111", "alice1111111", core_sym::from_string("300000000.00000000"), core_sym::from_string("300000000.00000000") ) );
//    //vote for producers
...
//    stake_with_transfer( config::system_account_name, N(sam), core_sym::from_string( "80000000.00000000" ), core_sym::from_string( "80000000.00000000" ) );
//    stake_with_transfer( config::system_account_name, N(dan), core_sym::from_string( "80000000.00000000" ), core_sym::from_string( "80000000.00000000" ) );
...
//    stake_with_transfer( config::system_account_name, N(bob),  core_sym::from_string( "35000000.00000000" ), core_sym::from_string( "35000000.00000000" ) );
//    stake_with_transfer( config::system_account_name, N(carl), core_sym::from_string( "35000000.00000000" ), core_sym::from_string( "35000000.00000000" ) );
...
//    stake_with_transfer( config::system_account_name, N(alice), core_sym::from_string( "10000000.00000000" ), core_sym::from_string( "10000000.00000000" ) );
...
//    for (const auto& v: voters) {
//       transfer( config::system_account_name, v, core_sym::from_string("200000000.00000000"), config::system_account_name );
//       BOOST_REQUIRE_EQUAL(success(), stake(v, core_sym::from_string("30000000.00000000"), core_sym::from_string("30000000.00000000")) );
//    }
...
//       BOOST_REQUIRE_EQUAL(success(), stake("producvoterd", core_sym::from_string("40000000.00000000"), core_sym::from_string("40000000.00000000")));
...
//    BOOST_REQUIRE_EQUAL( asset::from_string("25000.00000000 REX"),  get_buyrex_result( alice, core_sym::from_string("2.5000") ) );
//    produce_blocks(2);
//    produce_block(fc::days(5));
//    BOOST_REQUIRE_EQUAL( core_sym::from_string("2.5000"),     get_sellrex_result( alice, asset::from_string("25000.00000000 REX") ) );
...
//    BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0001"),            get_sellrex_result( alice, asset::from_string("1.00000000 REX") ) );
//    BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0001"),            get_sellrex_result( alice, asset::from_string("1.9999 REX") ) );
//    BOOST_REQUIRE_EQUAL( core_sym::from_string("0.0002"),            get_sellrex_result( alice, asset::from_string("2.00000000 REX") ) );
...
//    const asset init_balance = core_sym::from_string("1000000.00000000");
//    const std::vector<account_name> accounts = { N(aliceaccount), N(bobbyaccount) };
//    account_name alice = accounts[0], bob = accounts[1];
//    setup_rex_accounts( accounts, init_balance );
...
//       BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient available rex"),
//                            sellrex( alice, asset::from_string("115000.00000000 REX") ) );
//       produce_block( fc::hours( 3*24 + 20) );
//       BOOST_REQUIRE_EQUAL( success(),          sellrex( alice, asset::from_string("300000.00000000 REX") ) );
...
//       produce_block( fc::hours(23) );
//       BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient available rex"),
//                            sellrex( alice, asset::from_string("250000.00000000 REX") ) );
//       produce_block( fc::days(1) );
//       BOOST_REQUIRE_EQUAL( success(),          sellrex( alice, asset::from_string("130000.00000000 REX") ) );
//       rex_balance = get_rex_balance_obj( alice );
...
//       BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient available rex"),
//                            sellrex( alice, asset::from_string("130000.00000000 REX") ) );
//       BOOST_REQUIRE_EQUAL( success(),          sellrex( alice, asset::from_string("120000.00000000 REX") ) );
//       rex_balance = get_rex_balance_obj( alice );
...
//    const asset stake_amount = core_sym::from_string("50000000.00000000");
//    const asset half_stake   = core_sym::from_string("25000000.00000000");
