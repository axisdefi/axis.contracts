...
namespace eosiosystem {
   ...
   static constexpr uint32_t seconds_per_year      = 52 * 7 * seconds_per_day;

   static constexpr int64_t  useconds_per_year     = int64_t(seconds_per_year) * 1000'000ll;
   static constexpr int64_t  useconds_per_day      = int64_t(seconds_per_day) * 1000'000ll;
   static constexpr int64_t  useconds_per_hour     = int64_t(seconds_per_hour) * 1000'000ll;

   // must be consitens with os/libraries/chain/include/eosio/chain/config.hpp
   // line 38:
   ...
   // @TODO:
   // need change according to axis's total supply. which is 24M.
   // 1 billion eos at ICO,  4 decimal place -> 150'000'000 / 1B -> 15%
   // Axis as major supply is reserved,  the threshhold defined as 10%
