...
namespace eosio {
   ...
   // /**
   //  * Extension of the `eosio::binary_extension class` that has assignment and copy-assignment operators.
   //  */
   // template<typename T>
   // class eosio_msig_binary_extension : public eosio::binary_extension<T> {
   //    // using eosio::binary_extension<T>::binary_extension;
   //    // using eosio::binary_extension<T>::binary_extension::has_value;
   //    // using eosio::binary_extension<T>::binary_extension::reset;
   //    // using eosio::binary_extension<T>::binary_extension::_data;
   //    // using eosio::binary_extension<T>::binary_extension::_has_value;
   // 
   ...
   //       if (eosio::binary_extension<T>::has_value())
   //          eosio::binary_extension<T>::reset();
   // 
   //       if (other.eosio::binary_extension<T>::has_value()) {
   //          ::new (&_data) T(*other);
   //          _has_value = true;
   //       }
   //       return *this;
